    ...
    <section className="w-full bg-[#050505] py-16 md:py-24 overflow-hidden">
      <div className="container mx-auto max-w-7xl px-4 md:px-6">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 md:mb-12 gap-6">
          <div>
            <span className="text-purple-400 text-xs font-bold tracking-widest uppercase mb-2 block">
              Start Your Journey
            </span>
        ...
        >
          {routes.map((route) => (
            <Link 
              ...
              className="
                ...
                bg-[#111]
                /* FIX 1: FORCE HARDWARE ACCELERATION TO PREVENT BLUR ARTIFACTS */
            ...
            >
              ...
              <div className="absolute inset-0 w-full h-full">
                <Image
                  ...
                  // FIX 2: INCREASED RESOLUTION for sharper images on high-DPI screens
              ...
              <div className="absolute top-4 right-4 z-10">
                {/* ENSURE NO BLUR HERE EITHER: Used solid semi-transparent bg */}
          ...
          <div className="md:hidden shrink-0 snap-center w-[150px] flex items-center justify-center">
