...
export function Navbar() {
  ...
  return (
    <>
        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 md:px-12">
          ...
          <div className="hidden items-center gap-8 md:flex">
            ...
            <div className="relative" ref={dropdownRef}>
              ...
              {/* Dropdown Panel */}
              <div
                className={`absolute top-full left-1/2 -translate-x-1/2 pt-4 w-72 transition-all duration-300 transform origin-top ${isDropdownOpen
      ...
      {/* --- MOBILE MENU OVERLAY --- */}
      <div
        className={`fixed inset-0 z-[90] bg-black/60 backdrop-blur-sm transition-opacity duration-300 md:hidden ${isOpen ? "opacity-100 visible" : "opacity-0 invisible pointer-events-none"
          }`}
      ...
      <div
        ref={mobileMenuRef}
        className={`fixed top-0 right-0 bottom-0 z-[95] w-[85%] max-w-sm bg-[#050505] border-l border-white/10 shadow-2xl transition-transform duration-500 md:hidden flex flex-col pt-24 px-6 ${isOpen ? "translate-x-0" : "translate-x-full"
          }`}
      >
